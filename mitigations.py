...
def create_mitigations_prompt(methodology, threats):
    prompt = f"""
Act as a cyber security expert with more than 20 years experience of using the {methodology} threat modelling methodology. 
Your task is to provide potential mitigations for the threats identified in the {threats} model. It is very important that 
...
def get_mitigations_openai(api_key, model_name, prompt):
